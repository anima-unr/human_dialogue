...
def depth(x_d,y_d):
    ...
    print cloud.width
    print cloud.fields.x
    print cloud.fields.y
    print cloud.fields.z
    ...
    depth = x_d + y_d*cloud.width
    # depth = x_d + y_d*1

    print cloud.fields[depth].x
    print cloud.fields[depth].y
    print cloud.fields[depth].z

    x = cloud.fields[depth].x
    y = cloud.fields[depth].y
    z = cloud.fields[depth].z
